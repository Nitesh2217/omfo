...
bot = telebot.TeleBot('7900762158:AAGowcCVti_iQ3ZWJrZikeRfdTxVcvLv4mg')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet purchase now from:- @Nitesh_021."
...
def welcome_start(message):
    user_name = message.from_user.first_name
    response = f'''💐𝐖𝐞𝐥𝐜𝐨𝐦𝐞 Nitesh_021 (OWNER) 𝐓𝐨 𝐎𝐮𝐫 𝐁𝐨𝐭 :-
🤖 STORM BOT 🤖
...
𝟑. 𝐌𝐚𝐤𝐞 𝐒𝐮𝐫𝐞 𝐘𝐨𝐮 𝐉𝐨𝐢𝐧𝐞𝐝  𝐓𝐡𝐞 𝐃𝐃𝐨𝐒 𝐖𝐢𝐥𝐥 𝐍𝐨𝐭 𝐖𝐨𝐫𝐤.
